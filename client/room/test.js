...
const testWin = (cards) => {
    ...
    for (let g in group) {
        ...
        if(remainCard.length===0){
            ...
            if(resultType_2.one.length===0&&resultType_2.two.length===0&&resultType_2.three.length!==0&&resultType_2.one.four===0){
                isWin = true;
                break;
            }
        }
...
//     { key: 'w-4-1', color: 'w', number: 4 }, { key: 'w-4-1', color: 'w', number: 4 }, { key: 'w-5-1', color: 'w', number: 5 }, { key: 'w-5-1', color: 'w', number: 5 }, { key: 't-7-1', color: 't', number: 7 }, { key: 't-7-1', color: 't', number: 7 },
